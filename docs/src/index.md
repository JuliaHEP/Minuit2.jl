...
RooFit-style model building is provided separately by [RooFitLite.jl](https://github.com/JuliaHEP/RooFitLite.jl), which integrates with Minuit2 through a package extension.
